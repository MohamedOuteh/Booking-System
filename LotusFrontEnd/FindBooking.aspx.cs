...
public partial class AdminViewBookings : System.Web.UI.Page
{
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        if (lstBooking.SelectedIndex !=-1)
        {
            ...
            Response.Redirect("BookingEdit.aspx?BookingDate=" + BookingDate + "&BookingTime=" + BookingTime /*+ Username + HaircutName*/);
        }
        else
        {
            //show error
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            //display error 
            lblError.Text = "Please select a booking from the list";
        }
